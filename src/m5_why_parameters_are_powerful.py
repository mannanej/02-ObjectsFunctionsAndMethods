...
def main():
    ...
    #better_draw_circles(rg.Point(100, -100), 20)
    #even_better_draw_circles(rg.Point(-50, 50), 10, 20, 'purple', 5)
    #even_better_draw_circles(rg.Point(50, -50), 20, 3, 'yellow', 10)

    even_better_draw_circles(rg.Point(200, 200), 5, 50, 'red', 1)
    even_better_draw_circles(rg.Point(-200, -200), 5, 50, 'blue', 1)
    even_better_draw_circles(rg.Point(200, -200), 5, 50, 'green', 1)
    even_better_draw_circles(rg.Point(-200, 200), 5, 50, 'purple', 1)
    even_better_draw_circles(rg.Point(0, 0), 5, 58, 'yellow', 1)
...
def even_better_draw_circles(point, radii, amount, color, thick):
    ...
    for k in range(amount):  # k becomes 1, 2, 3, ... 10
